...
| [other/cronjobs.md](./other/cronjobs.md) | HTTP crons: backup, email pipeline, producers, % — **ops key**, **implemented** |
...
| `/wapi` | `cron.route.ts` (backup, email schedule pipeline, campaign producers — **X-Ops-Key**) |
